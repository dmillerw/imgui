            ...
            for (cmd in cmdList.cmdBuffer) {
                ...
                // User callback (registered via ImDrawList::AddCallback)
                    ...
                    if (clipRectX < fbWidth && clipRectY < fbHeight && clipRectZ >= 0f && clipRectW >= 0f) {
                        ...
                        // Bind texture, Draw
                        val pair = Pair(scissor, intArrayOf(cmd.elemCount * 3, 1, 0, idxBufferOffset.toInt(), 0))
                        ...
                        //glScissor(scissor)
                        //glDrawElementsIndirect(GL_TRIANGLES, GL_UNSIGNED_INT, intArrayOf((cmdList.idxBuffer.lastElement() - cmdList.idxBuffer.firstElement()) * 2, 1, 0, idxBufferOffset.toInt(), 0))
                    }
                }
