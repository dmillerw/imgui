...
val BUFFER_MEMORY_ALIGNMENT = VkDeviceSize(256)
...
private data class FrameData(
        ...
        val fence: VkFence,
        val imageAcquiredSemaphore: VkSemaphore,
        val renderCompleteSemaphore: VkSemaphore
)

private data class WindowData(
        val width: Int,
        val height: Int,
        val swapchain: KHRSwapchain,
        val surface: KHRSurface,
        ...
        val backbufferCount: Int,
        val backBuffer: Array<VkImage>,
...
private data class FrameDataForRender(
        val vertexBufferMemory: VkDeviceMemory,
        val indexBufferMemory: VkDeviceMemory,
        val vertexBufferSize: VkDeviceSize,
        val indexBufferSize: VkDeviceSize,
        val vertexBuffer: VkBuffer,
        val indexBuffer: VkBuffer
)
...
class ImplVk(val initInfo: ImGuiVulkanInitInfo, val renderPass: VkRenderPass) : LwjglRendererI {
    ...
    var frameIndex = 0
    private var framesDataBuffers = Array<FrameDataForRender?>(2) { null }

    var fontSampler = VkSampler.NULL
    var fontMemory = VkDeviceMemory.NULL
    var fontImage = VkImage.NULL
    var fontImageView = VkImageView.NULL
